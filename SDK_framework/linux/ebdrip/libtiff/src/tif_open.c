/* $HopeName: HQNlibtiff!src:tif_open.c(EBDSDK_P.1) $ */

/* $Id: src:tif_open.c,v 1.2.1.1.1.1 2013/12/19 11:24:39 anon Exp $ */
...
)
{
	...
	case 'r':
		...
		if (tif->tif_flags & TIFF_MAPPED)
		{
			...
			typedef tdata_t __attribute__((__may_alias__)) tdata_t_alias;
#else
			typedef tdata_t tdata_t_alias;
#endif

			if (!TIFFMapFileContents(tif, (tdata_t_alias *) &tif->tif_base, &tif->tif_size))
			{
				tif->tif_flags &= ~TIFF_MAPPED;
			}
		}
