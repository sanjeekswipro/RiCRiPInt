/* $HopeName: HQNlibtiff!src:tif_dir.c(EBDSDK_P.1) $ */

/* $Id: src:tif_dir.c,v 1.2.1.1.1.1 2013/12/19 11:24:39 anon Exp $ */
...
_TIFFVSetField(TIFF* tif, ttag_t tag, va_list ap)
{
	...
	case TIFFTAG_INKNAMES:
	    ...
	    if (fip->field_type == TIFF_ASCII) {
		    ...
		    typedef char * __attribute__((__may_alias__)) char_star_alias;
#else
		    typedef char * char_star_alias;
#endif
		    _TIFFsetString((char_star_alias *)&tv->value, va_arg(ap, char *));
	    }
	    else {
