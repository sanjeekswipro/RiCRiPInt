/* $HopeName: HQNlibtiff!src:tif_dirread.c(EBDSDK_P.1) $ */

/* $Id: src:tif_dirread.c,v 1.2.1.1.1.1 2013/12/19 11:24:40 anon Exp $ */
...
TIFFFetchFloatArray(TIFF* tif, TIFFDirEntry* dir, float* v)
{
	...
	if (dir->tdir_count == 1) {
		_TIFFmemcpy(v, &dir->tdir_offset, sizeof(dir->tdir_offset));
