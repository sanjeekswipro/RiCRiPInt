/* $HopeName: HQNlibtiff!src:tif_dirinfo.c(EBDSDK_P.1) $ */

/* $Id: src:tif_dirinfo.c,v 1.2.2.1.1.1 2013/12/19 11:24:39 anon Exp $ */
	...
	if(dt != TIFF_ANY) {
	    ...
	    const TIFFFieldInfo **ret;
            ...
            ret = (const TIFFFieldInfo **) lfind(&pkey,
						 tif->tif_fieldinfo, 
#ifdef WIN32 /* Yuck. tiffiop.h uses a prototype that is incompatible with Windows CRT. */
                                                 (unsigned int *)
#endif
						 &tif->tif_nfields,
						 sizeof(TIFFFieldInfo *),
