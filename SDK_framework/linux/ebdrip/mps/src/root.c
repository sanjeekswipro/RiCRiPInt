 ...
 *
 * $Id: root.c,v 1.37.1.1.1.1 2013/12/19 11:27:09 anon Exp $
 * $HopeName: MMsrc!root.c(EBDSDK_P.1) $
...
SRCID(root, "$Id: root.c,v 1.37.1.1.1.1 2013/12/19 11:27:09 anon Exp $");
...
/* RootPM -- return the grey set of a root */

TraceSet RootGrey(Root root)
{
  AVERT(Root, root);
  return root->grey;
}
...
/* RootGreyAdd -- mark root grey for trace */

void RootGreyAdd(Root root, Trace trace)
{
  AVERT(Root, root);
  AVERT(Trace, trace);
