 ...
 *
 * $Id: protocol.c,v 1.4.31.1.1.1 2013/12/19 11:27:06 anon Exp $
 * $HopeName: MMsrc!protocol.c(EBDSDK_P.1) $
...
SRCID(protocol, "$Id: protocol.c,v 1.4.31.1.1.1 2013/12/19 11:27:06 anon Exp $");
