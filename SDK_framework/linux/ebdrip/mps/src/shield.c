 ...
 *
 * $Id: shield.c,v 1.18.1.1.1.1 2013/12/19 11:27:07 anon Exp $
 * $HopeName: MMsrc!shield.c(EBDSDK_P.1) $
...
SRCID(shield, "$Id: shield.c,v 1.18.1.1.1.1 2013/12/19 11:27:07 anon Exp $");
...
Bool (SegIsShielded)(Seg seg)
{
  AVERT(Seg, seg);
  return SegSM(seg) != AccessSetEMPTY;
}
