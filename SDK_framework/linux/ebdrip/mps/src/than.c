 ...
 *
 *  $Id: than.c,v 1.21.31.1.1.1 2013/12/19 11:27:06 anon Exp $
 *  $HopeName: MMsrc!than.c(EBDSDK_P.1) $
...
SRCID(than, "$Id: than.c,v 1.21.31.1.1.1 2013/12/19 11:27:06 anon Exp $");
