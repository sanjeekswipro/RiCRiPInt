 ...
 *
 * $Id: mpm.c,v 1.40.6.1.1.1 2013/12/19 11:27:10 anon Exp $
 * $HopeName: MMsrc!mpm.c(EBDSDK_P.1) $
...
SRCID(mpm, "$Id: mpm.c,v 1.40.6.1.1.1 2013/12/19 11:27:10 anon Exp $");
      ...
      if (*format != '$') {
        ...
        switch(*format) {
          ...
          case 'F': {                   /* function */
            ...
            /* Function ptrs may not be cast to int, so extract byte by byte. */
            Byte *b = (Byte *)&f;
