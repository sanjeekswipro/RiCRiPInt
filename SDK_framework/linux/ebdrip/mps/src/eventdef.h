 ...
 *
 * $Id: eventdef.h,v 1.35.1.1.1.1 2013/12/19 11:27:04 anon Exp $
 * $HopeName: MMsrc!eventdef.h(EBDSDK_P.1) $
 ...
 *   - Code: The unique 8-bit code associated with this event type;
...
RELATION(ArenaCreateSH                   , 0x0010, TRUE, Arena, PWW)
...
RELATION(PoolAllocDebug                  , 0x001d, TRUE, Object, PAWWW)
...
RELATION(TraceResolve                    , 0x0023, TRUE, Ref, PPAUU)
...
RELATION(PoolInitEPVM                    , 0x0045, TRUE, Pool, PPPWW)
...
RELATION(PoolPop                         , 0x0061, TRUE, Object, PW)
