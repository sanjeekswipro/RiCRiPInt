 ...
 *
 * $Id: reserv.c,v 1.8.31.1.1.1 2013/12/19 11:27:07 anon Exp $
 * $HopeName: MMsrc!reserv.c(EBDSDK_P.1) $
...
SRCID(reserv, "$Id: reserv.c,v 1.8.31.1.1.1 2013/12/19 11:27:07 anon Exp $");
