 ...
 *
 * $Id: poolsnc.c,v 1.17.10.1.1.1 2013/12/19 11:27:10 anon Exp $
 * $HopeName: MMsrc!poolsnc.c(EBDSDK_P.1) $
...
SRCID(poolsnc, "$Id: poolsnc.c,v 1.17.10.1.1.1 2013/12/19 11:27:10 anon Exp $");
...
static void SNCWalk(Pool pool, Seg seg, FormattedObjectsStepMethod f, void *p)
{
  AVERT(Pool, pool);
  AVERT(Seg, seg);
  AVER(FUNCHECK(f));
...
mps_class_t MPS_CALL mps_class_snc(void)
{
