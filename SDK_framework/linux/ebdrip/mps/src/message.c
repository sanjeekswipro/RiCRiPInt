 ...
 *
 * $Id: message.c,v 1.13.31.1.1.1 2013/12/19 11:27:08 anon Exp $
 * $HopeName: MMsrc!message.c(EBDSDK_P.1) $
...
SRCID(message, "$Id: message.c,v 1.13.31.1.1.1 2013/12/19 11:27:08 anon Exp $");
