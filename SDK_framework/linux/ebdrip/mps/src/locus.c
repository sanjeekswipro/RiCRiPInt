 ...
 *
 * $Id: locus.c,v 1.7.31.1.1.1 2013/12/19 11:27:06 anon Exp $
 * $HopeName: MMsrc!locus.c(EBDSDK_P.1) $
...
SRCID(locus, "$Id: locus.c,v 1.7.31.1.1.1 2013/12/19 11:27:06 anon Exp $");
