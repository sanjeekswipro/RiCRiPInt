 ...
 *
 * $Id: lockli.c,v 1.3.31.1.1.1 2013/12/19 11:27:05 anon Exp $
 * $HopeName: MMsrc!lockli.c(EBDSDK_P.1) $
...
SRCID(lockli, "$Id: lockli.c,v 1.3.31.1.1.1 2013/12/19 11:27:05 anon Exp $");
