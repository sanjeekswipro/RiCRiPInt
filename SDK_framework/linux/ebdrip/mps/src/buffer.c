 ...
 *
 * $Id: buffer.c,v 1.65.31.1.1.1 2013/12/19 11:27:08 anon Exp $
 * $HopeName: MMsrc!buffer.c(EBDSDK_P.1) $
...
SRCID(buffer, "$Id: buffer.c,v 1.65.31.1.1.1 2013/12/19 11:27:08 anon Exp $");
