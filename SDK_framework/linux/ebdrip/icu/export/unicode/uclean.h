/* $HopeName: HQNlibicu_3_4!export:unicode:uclean.h(EBDSDK_P.1) $ */
/*
******************************************************************************
*                                                                            *
...
/**
  *  Pointer type for a user supplied file open function. Behavior should be
  *  similar the standard C library fopen().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param filename The name of the file to be opened
  *  @param mode    The read/write open mode of the file to be opened
  *  @return        File handle of the opened file, or NULL if the open failed.
  *  @draft HQN
  *  @system
  */
typedef void *U_CALLCONV UFileOpenFn(const void *context, const char *filename, const char *mode);
/**
  *  Pointer type for a user supplied file close function. Behavior should be
  *  similar the standard C library fclose().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param handle    File handle of the file to be closed
  *  @draft HQN
  *  @system
  */
typedef void U_CALLCONV UFileCloseFn(const void *context, void *handle);
/**
  *  Pointer type for a user supplied file read function. Behavior should be
  *  similar the standard C library fread().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param addr    Address to read data into.
  *  @param bytes   Number of bytes to read from the file.
  *  @param handle  File handle of the file to read from.
  *  @return        The number of bytes read from the file.
  *  @draft HQN
  *  @system
  */
typedef int32_t U_CALLCONV UFileReadFn(const void *context, void *addr, int32_t bytes, void *handle);
/**
  *  Pointer type for a user supplied file write function.  Behavior should be
  *  similar the standard C library fwrite().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param addr    Address of data to write.
  *  @param bytes   Number of bytes to write to the file.
  *  @param handle  File handle of the file to write to.
  *  @return        The number of bytes written from the file.
  *  @draft HQN
  *  @system
  */
typedef int32_t U_CALLCONV UFileWriteFn(const void *context, const void *addr, int32_t bytes, void *handle);
/**
  *  Pointer type for a user supplied file rewind function.  Behavior should be
  *  similar the standard C library rewind().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param handle  File handle of the file to rewind.
  *  @draft HQN
  *  @system
  */
typedef void U_CALLCONV UFileRewindFn(const void *context, void *handle);
/**
  *  Pointer type for a user supplied file size inquiry function. The function
  *  should not alter the current file pointer.
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param handle  File handle of the file to find size.
  *  @return size of the file.
  *  @draft HQN
  *  @system
  */
typedef int32_t U_CALLCONV UFileSizeFn(const void *context, void *handle);
/**
  *  Pointer type for a user supplied inquiry function for end of file. Behavior should be
  *  similar the standard C library feof().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param handle  File handle of the file to test for EOF.
  *  @return A true value if the file pointer is at the end of the file.
  *  @draft HQN
  *  @system
  */
typedef int U_CALLCONV UFileEofFn(const void *context, void *handle);
/**
  *  Pointer type for a user supplied file removal function. Behavior should be
  *  similar the standard C library remove().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param filename  File handle of the file to test for EOF.
  *  @return Zero if the file was removed successfully.
  *  @draft HQN
  *  @system
  */
typedef int U_CALLCONV UFileRemoveFn(const void *context, const char *filename);
/**
  *  Pointer type for a user supplied inquiry function for file operation errors.
  * Behavior should be similar the standard C library ferror().
  *  @param context user supplied value, obtained from from u_setFileFunctions().
  *  @param handle  File handle of the file to test for errors.
  *  @return A true value if previous file operations caused an error.
  *  @draft HQN
  *  @system
  */
typedef int U_CALLCONV UFileErrorFn(const void *context, void *handle);
