/* $HopeName: HQNlibicu_3_4!common:udata.c(EBDSDK_P.1) $ */
/*
******************************************************************************
*
...
/*----------------------------------------------------------------------*
 *                                                                      *
 *  Gets a static reference to the common data library                  *
 *   Unless overridden by an explicit udata_setCommonData, this will be *
 *      our common data.                                                *
 *                                                                      *
 *----------------------------------------------------------------------*/
extern void * getStubData( void );
               ...
               UErrorCode *pErrorCode)
{
    ...
    if (isICUData) {
        ...
        tData.pHeader = (DataHeader *) getStubData();
