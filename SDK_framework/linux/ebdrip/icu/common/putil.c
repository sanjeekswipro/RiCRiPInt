/* $HopeName: HQNlibicu_3_4!common:putil.c(EBDSDK_P.1) $ */
/*
******************************************************************************
*
...
#if !defined(PTX)  && !defined(VXWORKS)
...
# if 0
    /* This is the original ICU code. It has type-punning warnings on gcc
       4.3+ which are not easy to avoid. */
...
# else
    ...
    return (UBool)((u.i64 & U_INT64_MAX) > gInf64);
# endif
#else
