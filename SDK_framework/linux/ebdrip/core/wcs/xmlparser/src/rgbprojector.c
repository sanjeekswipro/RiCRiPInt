 ...
 * \ingroup wcs
 *
 * $HopeName: COREwcs!xmlparser:src:rgbprojector.c(EBDSDK_P.1) $
 * $Id: xmlparser:src:rgbprojector.c,v 1.1.10.1.1.1 2013/12/19 11:25:08 anon Exp $
 *
 * Copyright (C) 2007 Global Graphics Software Ltd. All rights reserved.
 * Global Graphics Software Ltd. Confidential Information.
 *
 * \brief
 * ColorDeviceModel callbacks for the RGB projector device
 */
      ...
      xmlGAttributes *attrs)
{
  ...
  cdm->device.rgbprojector.rgbprimaries.white = cie ;
      ...
      xmlGAttributes *attrs)
{
  ...
  cdm->device.rgbprojector.rgbprimaries.red = cie ;
      ...
      xmlGAttributes *attrs)
{
  ...
  cdm->device.rgbprojector.rgbprimaries.green = cie ;
      ...
      xmlGAttributes *attrs)
{
  ...
  cdm->device.rgbprojector.rgbprimaries.blue = cie ;
      ...
      xmlGAttributes *attrs)
{
  ...
  cdm->device.rgbprojector.rgbprimaries.black = cie ;
      ...
      xmlGAttributes *attrs)
{
  ...
  xml_doc->rgbsamplesptr = &cdm->device.rgbprojector.colorsamples ;
...
wcsElementFuncts wcs_CDM_RGBProjectorDevice_functs[] =
{
