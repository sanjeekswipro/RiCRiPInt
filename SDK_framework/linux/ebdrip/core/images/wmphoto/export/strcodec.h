...
#define __STRCODEC_H__ (1)

/** \file
 * \ingroup hdphoto
 *
 * $HopeName: COREwmphoto!export:strcodec.h(EBDSDK_P.1) $ 
 *
...
#define ALIGNUP(p, s) ((void*)( ((UINTPTR_T)(p) + ((s) - 1)) & (~((UINTPTR_T)((s) - 1)))  ))
