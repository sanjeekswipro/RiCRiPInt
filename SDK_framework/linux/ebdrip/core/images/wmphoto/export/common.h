 ...
 * \ingroup hdphoto
 *
 * $HopeName: COREwmphoto!export:common.h(EBDSDK_P.1) $ 
 *
 * Copyright (C) Microsoft Corporation. All rights reserved.
 *
 * \brief
 * Header with common image structures/enums/types etc
 */
...
CAdaptiveHuffman *AllocateWMP (Int iNSymbols, CODINGMODE cm);
