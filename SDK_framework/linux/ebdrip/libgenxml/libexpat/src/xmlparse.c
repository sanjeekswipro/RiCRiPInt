/* $HopeName: HQNlibexpat!src:xmlparse.c(EBDSDK_P.1) $ */
             ...
             DTD *dtd)
{
  ...
  if (memsuite) {
    ...
    XML_Memory_Handling_Suite *mtemp;
    parser = (XML_Parser)expat_malloc(sizeof(struct XML_ParserStruct));
    if (parser != NULL) {
      mtemp = (XML_Memory_Handling_Suite *)&(parser->m_mem);
      mtemp->malloc_fcn = expat_malloc;
      mtemp->realloc_fcn = expat_realloc;
      mtemp->free_fcn = expat_free;
    }
  }
