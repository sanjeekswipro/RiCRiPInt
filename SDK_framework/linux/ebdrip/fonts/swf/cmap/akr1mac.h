...
%%BeginResource: CMap (Adobe-Korea1-H-Mac)
%%Title: (Adobe-Korea1-H-Mac Adobe KSCpc-EUC 0)
%%Version: 1.000
%%Copyright: -----------------------------------------------------------
...
/Registry (Adobe) def
/Ordering (KSCpc-EUC) def
/Supplement 0 def
end def

/CMapName /Adobe-Korea1-H-Mac def
