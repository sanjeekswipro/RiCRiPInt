...
#define TTF_DIR  sfnt_DirectoryEntry
...
#define TTF_HEADER  sfnt_OffsetTable
...
#define MAXP_MAXFUNCTIONDEFS_OFFSET   20
...
#define TTF_HEAD  sfnt_FontHeader
...
#define TTF_HHEA  sfnt_HorizontalHeader
...
#define TTF_MAXP	sfnt_maxProfileTable
...
#define MAX_TT_VALIDATION_ERRS 50
...
typedef struct {
	...
	UW16 numGlyphs;
	SW16 indexToLocFormat;
	UW16 numberOfHMetrics;
	SW16 numberOfErrors;
	SW16 errors[MAX_TT_VALIDATION_ERRS];
	UL32 filelen;
	INTG nFile;
} truetype_type;
...
/* The structures fnt_funcDef and fnt_instrDef were moved from FNT.H */
typedef struct {
...
#ifdef FS_EDGE_TECH
/* what is the LEAST we can define in TTF structure? */
