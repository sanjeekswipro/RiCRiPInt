...
# they are running on.
#
# $HopeName: HQNperl5libs!Platform.pm(EBDSDK_P.1) $
#
...
sub _init {
  ...
  # ARM endian-architectures are compatible with unspecified endianness,
  # which in turn is compatible with generic ARM architecture.
  _AssertArchCompat("armv8l", "armv8");
  _AssertArchCompat("armv8h", "armv8");
  _AssertArchCompat("armv8", "arm");
  _AssertArchCompat("armv7l", "armv7");
  _AssertArchCompat("armv7h", "armv7");
  _AssertArchCompat("armv7", "arm");
  _AssertArchCompat("armv6l", "armv6");
  _AssertArchCompat("armv6h", "armv6");
  _AssertArchCompat("armv6", "arm");
  _AssertArchCompat("armv5l", "armv5");
  _AssertArchCompat("armv5h", "armv5");
  _AssertArchCompat("armv5", "arm");
  # ARM core compatibility does not follow architecture number.
